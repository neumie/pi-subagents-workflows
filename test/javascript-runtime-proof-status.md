...
The path-scoped workflow runs the source and clean-packed fixture under exact Node.js 24.18.0 on Ubuntu 24.04, macOS 14, and Windows Server 2022. Keeping this fixture on `main` preserves reviewable evidence about the disposable candidate without granting it production authority.
